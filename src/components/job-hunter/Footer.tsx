        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <span className="text-lg font-bold text-white">RealTech Labs</span>
                <span className="text-xs text-slate-400 block">Job Hunter</span>
              </div>
            </div>
            <p className="text-slate-400 text-sm mb-6 max-w-xs">
              AI-powered job matching that understands your skills and connects you with opportunities that matter.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-slate-500 text-sm flex items-center gap-1">
              Made with <Heart className="w-4 h-4 text-red-500 fill-red-500" /> for job seekers everywhere
            </p>
          </div>
        </div>
      </div>
